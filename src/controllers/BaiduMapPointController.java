...
public class BaiduMapPointController extends ApplicationController {
	 ...
	 * @throws JError
	 */
	public static ArrayList<BaiduMapPointModels> getBMPS(	Connection con,
															Integer tp,
															String csbm,
															String title) throws JError {
		...
		try {
			...
			while (rs.next()) {
				if (albmps == null)
					albmps = new ArrayList<BaiduMapPointModels>();

...
<%
  for (int i = 0; i < su.getFiles().getCount(); i++) {
    ...
    try {
      ...
      fr = new InputStreamReader(new FileInputStream(request.getSession().getServletContext().getRealPath("/")
      ...
      try {if (fr != null)fr.close();if (br != null) br.close();} catch (IOException ex) {}

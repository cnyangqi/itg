...
function createSearch() {
  $("<div class='datagrid-btn-separator'></div>'").appendTo(".datagrid-toolbar");
...
function exportToExcel() {
  ...
  for ( var i = 0; i < rows.length; i++) {
   ...
   var bWin = window.open(page,'browseWin','resizable,scrollbars=yes,width=500,height=500,screenX=300,screenY=400');
   bWin.focus();
}

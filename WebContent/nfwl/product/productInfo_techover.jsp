...
<head>
    ...
    <script language="Javascript">
      ...
      function setValue(productclasscontrol,productclass_name,productclassidcontrol,productclassid){
        ...
        document.inputFrm.topic.value=productclass_name;      
        document.inputFrm.top_id.value=productclassid;    
      }
      function selectTopics()
      {
        
          page='/nfwl/product/selectPorductClass.jsp?productclasscontrol=topic&productclassidcontrol=top_id' ;
      ...
      {
          var rc = popupDialog("postremote.jsp?art_id=<%=Utils.Null2Empty(prd_id)%>");
          return false;
      }
      ...
      function uploadimage()
      {
          ...
          document.resFrm.siteid.value = 'abcd';
      ...
      function attachlist()
      {
          ...
          document.resFrm.siteid.value = 'abc';
      ...
      function uploadfiles()
      {
          ...
          document.resFrm.siteid.value = 'ancd';
          document.resFrm.multiple.value = "1";
          document.resFrm.func.value = "AddResource";
          document.resFrm.action="uploadresource.jsp";
          document.resFrm.submit();
...
<table width="100%" cellpadding="0" border="1" cellspacing="0">
    ...
    <input type="hidden" name="id"  value="<%=Utils.Null2Empty(prd_id)%>">
    ...
    <tr>
      ...
      <tr>
        ...
        <td>
           <script language="JavaScript" >
        <%=com.nfwl.itg.common.ITG_ZONEINFO.getJSString(con,"cjgTree","prd_originprovinceid","","","EXCEPT_ROOT_ELEMENT") %>        
        </script>  

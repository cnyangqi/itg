...
<BODY leftmargin="0" topmargin="0" style="background-color: #fafaf0;overflow-y: hidden;">
    ...
    <script language="javascript">
        ...
        topictree.setXMLAutoLoading("ajaxtopics.jsp?isBusiness=1");
        topictree.attachEvent("onXLE", f_xle);
        topictree.loadXML("ajaxtopics.jsp?id=0&isBusiness=1");
    ...
    <form name="artform" method="post" target="artMain" action="productlist.jsp">

...
<%
   ...
   //虚拟构造一个VisualModule
   TabModule module = new TabModule(mod_id,type);
            ...
            <UL class=buttons>
                <LI>
                    <DIV id="<%=module.HTML_ButtonDelete()%>">
                        <A title="<%=module_bundle.getString("TEMPLATE_DELETE_HINT")%>" onclick="tabseditor_<%=tabs_id%>.removeModule('<%=tab_id%>','<%=mod_id%>'); return false;" href="#">
                ...
                <LI>
                    <DIV id="<%=module.HTML_ButtonUp()%>">
                        <A title="<%=module_bundle.getString("TEMPLATE_UP_HINT")%>" onclick="tabseditor_<%=tabs_id%>.moveModuleUp('<%=tab_id%>','<%=mod_id%>'); return false;" href="#">
                ...
                <LI>
                    <DIV id="<%=module.HTML_ButtonDown()%>">
                        <A title="<%=module_bundle.getString("TEMPLATE_DOWN_HINT")%>" onclick="tabseditor_<%=tabs_id%>.moveModuleDown('<%=tab_id%>','<%=mod_id%>'); return false;" href="#">

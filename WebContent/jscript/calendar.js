...
function CalendarInit()                ///Create panel
{
    ...
    htmlAll = "<div id='" + this.sDIVID + "' style='z-index:10;display:none;position:absolute;width:" + this.Width + ";border:" + this.divBorderCss + ";padding:2px;background-color:#FFFFFF'>";
...
function CalendarCellsClick(oCell, oInstance)
{
    ...
    sDay = oInstance.currDate.getDate();
		//debugger;
    if (oCell.innerText != " "&&oCell.innerText != "")
    {
